...
// PNJ cohérents, fragments & boss, hub village, pas de sauvegarde/chargement.

// ———————————————————————————————————————————————————————————
// 0) QoL mobile : garder l’écran éveillé (silencieux si non supporté)
// ———————————————————————————————————————————————————————————
let wakeLock;
...
// --- Helpers UI robustes (corrigent le blocage des clics) ---
let _eventLocked = false;
...
function addChoice(label, handler, primary=false){
  ...
  btn.addEventListener('click', ()=> {
    ...
    try { handler(); }
      ...
      console.error('[Mirval] Action error:', err);
      write("⚠️ Action interrompue.","warn");
      // On redonne la main et propose un filet de sécurité
      _eventLocked = false;
      if(!ui.choices.children.length){
        addChoice("Continuer", ()=>explore(true), true);
      }
    }
    // NOTE : le prochain écran appelle clearChoices() qui déverrouille.
  });
...
// ———————————————————————————————————————————————————————————
// 5) Aides gameplay + économie + équipement
// ———————————————————————————————————————————————————————————
...
// ———————————————————————————————————————————————————————————
// 6) Level-up + proposition de formation (compétences avancées)
// ———————————————————————————————————————————————————————————
function levelUp(){
...
// ———————————————————————————————————————————————————————————
// 8) Boutique : stock marché & forge (achat/vente)
// ———————————————————————————————————————————————————————————
const shopStock = {
  market: [
...
// ———————————————————————————————————————————————————————————
// 9) COMBAT — CORRIGÉ (actions cliquables, pas de blocage)
// ———————————————————————————————————————————————————————————
...
// ———————————————————————————————————————————————————————————
// 11) Temps & exploration (sécurisé, anti-bloqueur)
// ———————————————————————————————————————————————————————————
function setTime(){
...
// ———————————————————————————————————————————————————————————
// 12) Rencontres forcées / aléatoires (PNJ/ennemis)
// ———————————————————————————————————————————————————————————
...
// ———————————————————————————————————————————————————————————
// 13) Village : Hub (achat/vente/chapelle/forge/maître)
// ———————————————————————————————————————————————————————————
function villageHub(){
...
// Nouvelle aventure après choix de classe (reset verrou & actions)
